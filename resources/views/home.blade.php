        ...
        <nav class="navbar navbar-expand-md navbar-dark fixed-top animated faded-In">
            <div class="container">
                ...
                <div class="collapse navbar-collapse text-center justify-content-end" id="navbar2SupportedContent">
                    ...
                    <a href="{{ route('login') }}" class="btn navbar-btn ml-2 btn-primary text-dark">
                        <i class="fa d-inline fa-lg fa-user-circle-o" href="/login" ></i> Sign in</a>
                </div>
            </div>
        </nav>
                    ...
                    <div class="col-md-5">
                        ...
                        <form class="form-inline">
                            <div class="input-group">
                                    <button class="btn btn-primary" type="button" href="/registerman">Register</button>
                                </div>
                            </div>
                        </form>
                    </div>
            ...
            <div class="container">
                ...
                <div class="row">
                    <div class="col-md-3 col-6 p-1">
                        <a href="#">
                            <img class="d-block img-fluid" src="/images/logo_bnw.png"> </a>
                    </div>
                    <div class="col-md-3 col-6 p-1">
                        <a href="#">
